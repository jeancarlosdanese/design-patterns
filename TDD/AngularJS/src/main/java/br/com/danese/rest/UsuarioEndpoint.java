...
import br.com.danese.model.Usuario;
...
public class UsuarioEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Usuario> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM Usuario u LEFT JOIN FETCH u.pessoa LEFT JOIN FETCH u.perfis WHERE u.id = :entityId ORDER BY u.id",
						Usuario.class);
	...
	public List<Usuario> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Usuario> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM Usuario u LEFT JOIN FETCH u.pessoa LEFT JOIN FETCH u.perfis ORDER BY u.id",
						Usuario.class);
