...
import br.com.danese.model.Endereco;
...
public class EnderecoEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Endereco> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT e FROM Endereco e LEFT JOIN FETCH e.pessoa WHERE e.id = :entityId ORDER BY e.id",
						Endereco.class);
	...
	public List<Endereco> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Endereco> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT e FROM Endereco e LEFT JOIN FETCH e.pessoa ORDER BY e.id",
						Endereco.class);
