...
import br.com.danese.model.Pessoa;
...
public class PessoaEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Pessoa> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT p FROM Pessoa p LEFT JOIN FETCH p.usuario LEFT JOIN FETCH p.emails LEFT JOIN FETCH p.enderecos LEFT JOIN FETCH p.telefones WHERE p.id = :entityId ORDER BY p.id",
						Pessoa.class);
	...
	public List<Pessoa> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Pessoa> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT p FROM Pessoa p LEFT JOIN FETCH p.usuario LEFT JOIN FETCH p.emails LEFT JOIN FETCH p.enderecos LEFT JOIN FETCH p.telefones ORDER BY p.id",
						Pessoa.class);
